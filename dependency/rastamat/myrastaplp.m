function [cepstra, spectra, pspectrum, lpcas, F, M] = myrastaplp(samples, sr, dorasta, modelorder)
...
if modelorder > 0
  ...
  %MY INVERSION ROUTINES
  invaspectrum=invpostaud(postspectrum,sr);
  invpspectrum=invaudspec(invaspectrum,sr);
  lpcas=dolpc(invpspectrum,8);
