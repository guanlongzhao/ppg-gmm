% [p,px_m,pxm,pm_x] = GMpdf_SA_test(X,mu,S[,pm,o]) Gaussian mixture pdf
%
...
function [p,px_m,pxm,pm_x] = GMpdf_SA_test(X,mu,S,pm,o)
...
if exist('o','var') & ~isempty(o)
  ...
  [p,px_m,pxm,pm_x] = GMpdf_SA_test(X(:,o.M),mu,S,pm,[]);
  return;
end
